<header id="masthead" class="site-header position-relative border-bottom border-gray-200 z-3 header-type4">
    <div class="header-row header-topbar position-relative d-none d-xl-block text-12 text-weight fw-medium header-row-primary-active text-gray-500 z-3">
        <div class="container">
    ...
    <div class="header-row header-main position-relative header-row-primary border-bottom">
        <div class="container">
			<div class="header-inner d-flex flex-wrap align-items-center justify-content-between gap-3 gap-sm-4">
							...
							<?php if($elementor_page){ ?>
								<a href="<?php echo esc_url( home_url( "/" ) ); ?>" title="<?php bloginfo("name"); ?>">
									...
									<?php } elseif (get_theme_mod( 'grogin_logo' )) { ?>
										<img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod( 'grogin_logo_white' )) ); ?>" alt="<?php bloginfo("name"); ?>">
						...
						<div class="quick-button style-1 location-selector-button">
							<a href="#" class="action-link modal-button" data-modal="location-selector">
							  ...
							  <div class="action-text">
								<span><?php esc_html_e('Deliver to','grogin'); ?></span>
								<p><?php echo esc_html(grogin_location()); ?></p>
							  </div><!-- action-text -->
							</a>
						</div><!-- quick-button -->
					<?php } ?>
				...
				<div class="col d-none d-xl-inline-flex align-items-center flex-auto gap-2">
					<?php grogin_account_icon(); ?>  
						
					<?php grogin_wishlist_icon(); ?>
