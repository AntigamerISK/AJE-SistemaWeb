...
/*----------------------------
  Product Type 1
 ----------------------------*/
function grogin_product_type1($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = '', $product_type = '', $product_sku = '', $productattributes = ''){
	global $product;
	global $post;
	global $woocommerce;
...
add_action('klb_product_box','grogin_product_type1', 10, 7); 