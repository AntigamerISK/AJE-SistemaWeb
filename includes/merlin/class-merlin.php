...
class Merlin {
	...
	protected function license() {
        if(grogin_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(grogin_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','grogin')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_50297090', $license_key );
