...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'grogin' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'grogin' );
...
<div class="quantity">
	...
	<input
		...
		aria-label="<?php esc_attr_e( 'Product quantity', 'grogin' ); ?>"
